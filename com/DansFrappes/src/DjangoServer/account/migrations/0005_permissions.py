...
class Migration(migrations.Migration):
    ...
    dependencies = [('account', '0001_initial',), ('account', '0002_useraccount_cart'), ('account', '0003_useraccount_hourly_wage_useraccount_hours_worked'), ('account', '0004_groups'), ('menu', '0004_drinks'), ('admin', '0003_logentry_add_action_flag_choices'), ('sessions', '0001_initial')]
